package com.example.tagihin.view.bill.savedbill.unpaid
...
class UnpaidSavedBillFragment : BaseFragment<SavedBillViewModel, FragmentPendingBinding>(
    ...
    override fun onViewReady() {
        ...
        viewModel._savedUnpaid.observe(this, Observer {
