...
class UnpaidWorkOrderAdapter(
    var multiSelectMode: Boolean = false,
    var context: Context,
    val onClickListener: UnpaidWorkOrderOnClickListener,
    private val retryCallback: () -> Unit,
    val multiSelectSupport: Boolean = false,
    diffCallback: DiffUtil.ItemCallback<UnpaidWorkOrder>
) : PagedListAdapter<UnpaidWorkOrder, RecyclerView.ViewHolder>(diffCallback) {
    ...
    inner class BillViewHolder(
        val binding: BillItemLayoutBinding, val onClickListener: UnpaidWorkOrderOnClickListener
    ) : RecyclerView.ViewHolder(
        binding.root
    ) {
        fun onBind(bill: UnpaidWorkOrder) {
            with(binding) {
...
interface UnpaidWorkOrderOnClickListener{
    fun onClick(bill: UnpaidWorkOrder)
