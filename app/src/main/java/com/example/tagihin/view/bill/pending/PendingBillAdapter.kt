...
class PendingBillAdapter(
    ...
    var context: Context,
    val onClickListener: PendingBillOnClickListener,
    private val retryCallback: () -> Unit,
    val multiSelectSupport: Boolean = false,
    diffCallback: DiffUtil.ItemCallback<PendingBill>
) : PagedListAdapter<PendingBill, RecyclerView.ViewHolder>(diffCallback) {
    ...
    inner class BillViewHolder(
        val binding: BillItemLayoutBinding, val onClickListener: PendingBillOnClickListener
    ) : RecyclerView.ViewHolder(
        binding.root
    ) {
        fun onBind(bill: PendingBill) {
            with(binding) {
...
interface PendingBillOnClickListener{
    fun onClick(bill: PendingBill)
